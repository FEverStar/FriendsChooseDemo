...
#import "YXUserEntity.h"

@interface ViewController ()<UITableViewDataSource,UITableViewDelegate,YXUserSearchBarDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (weak, nonatomic) IBOutlet YXUserSearchBar *searchBar;
...
//    [view setBackgroundColor:[UIColor redColor]];
    ...
    for (int i = 0; i < 10; i ++) {
        ...
        YXUserEntity *user = [[YXUserEntity alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    id<YXUser>user = [self.dataList objectAtIndex:indexPath.row];
